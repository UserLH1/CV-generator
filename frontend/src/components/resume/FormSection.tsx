    ...
    <div>
      <div className="flex justify-between items-center mb-4">
        ...
        <div className="flex gap-2">
          ...
          <Button disabled={!enableNext} className="flex gap-2 text-white border rounded" size="sm" onClick={() => setActiveFormIndex(prevIndex => prevIndex + 1)}>Next<ArrowRight/></Button>
        </div>
      </div>
      {/* Personal Detail */}
